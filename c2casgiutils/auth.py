...
if _auth_type == AuthenticationType.GITHUB:
    ...
    async def c2c_github_login(
        request: Request,
        response: Response,
        came_from: Annotated[str | None, Depends(Query(None))] = None,
    ) -> RedirectResponse:
    ...
    async def c2c_github_callback(
        request: Request,
        response: Response,
        came_from: Annotated[str | None, Query(None)] = None,
        state: Annotated[str | None, Query(None)] = None,
        code: Annotated[str | None, Query(None)] = None,
        error: Annotated[str | None, Query(None)] = None,
